...
export default function Home({ }: Props) {
  ...
  return (
    <div className="container flex sm:flex-row flex-col-reverse">
      ...
      <div className="flex min-h-fit sm:min-h-full justify-center items-center sm:w-[50%] bg-[#F4631A] p-[20px] sm:h-[calc(100vh-68px)] md:h-[calc(100vh-92px)] h-[calc(50vh-34px)]">
        <div>
      ...
      <div className=" flex min-h-fit sm:min-h-full items-center justify-center sm:w-[50%] flex-col bg-[#333333] gap-[10px] sm:h-[calc(100vh-68px)] md:h-[calc(100vh-92px)] h-[calc(50vh-34px)] p-[20px]">
